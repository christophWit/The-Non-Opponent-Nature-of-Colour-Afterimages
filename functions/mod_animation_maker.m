...
for im = 1:im_n
    ...
    text(0,0.01, sprintf('  Witzel (2025) The non-opponent nature of colour afterimages.\n\\it  Communications Psychology\\rm, https://doi.org/10.1038/s44271-025-00331-5.'),...
        'Units','Normalized','FontSize', 5,...
